...
def app():
    ...
    with app.app_context():
        ...
        station1 = Stations(name='Station 1', point=10, bonus_time_seconds=30, session=test_session.id)
        station2 = Stations(name='Station 2', point=20, bonus_time_seconds=60, session=test_session.id)
